    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new StyleBundle("~/Styles").Include(
                      ...
                      "~/Content/css/owl-coursel/owl.carousel.css",
                      "~/Content/css/owl-coursel/owl.transitions.css",
            ...
            bundles.Add(new ScriptBundle("~/Scripts").Include(
                      ...
                      "~/Scripts/js/jquery/jquery-ui.js",
                      "~/Scripts/js/bootstrap/bootstrap.min.js",
                      "~/Scripts/js/owl-coursel/owl.carousel.js",
                      "~/Scripts/js/magnific-popup/jquery.magnific-popup.min.js",
